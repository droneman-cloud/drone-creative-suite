...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Droneman — Creative Content & Drone Visual Specialist" },
      { name: "description", content: "Portfolio of Droneman — Creative Content Strategist, Drone Visual Specialist, and Network Support Engineer based in Kannur, Kerala." },
      { name: "author", content: "Droneman" },
